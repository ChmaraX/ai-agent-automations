...
Automations for repository cleanup, safer fixes, missing test coverage, and recurring maintenance work.
...
Automations for pull request routing, CI cost and runtime review, CI optimization, and GitHub-based release summaries.
...
### Inbox & Research Digests

Automations for Gmail workflows and compact digests built from recurring information feeds.
...
### Support, Billing & Customer Ops

Automations for support signal, renewal risk, billing issues, subscription churn watchlists, and Stripe operational checks.
...
Automations for New Relic, Sentry, and Slack-based production triage and follow-up.
...
Automations for Atlas cost, performance, security, query health, and production data contract drift.
...
### Security & Local Monitoring

Automations for local host checks, code and dependency risk review, and external security signal.
...
Automations that create, route, or sync follow-up work into Linear.
...
Automations for lightweight recurring market and ecosystem research.
